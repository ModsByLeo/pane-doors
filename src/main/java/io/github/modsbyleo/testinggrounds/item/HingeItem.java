...
public final class HingeItem extends DoorComponentItem {
    public HingeItem(Settings settings) {
        super(settings);
    }
    ...
    public boolean updateDoorComponent(@NotNull ItemUsageContext ctx, @NotNull BlockState state,
        ...
        return placeComponent(ctx, state, DoorComponentBlock.ComponentType.HINGE);
    }
}
